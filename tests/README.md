...
- [test_cdlgssm_dlgssm_match.py](./test_cdlgssm_match.py) checks that cd-dynamax's CD-LGSSM implementation matches the Discrte Linear Gaussian SSM implementation of dynamax, when sampling, filtering, smoothing, forecasting and sampling emissions from model.
