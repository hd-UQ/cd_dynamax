...
# Finally, show that the linear smoother and nonlinear EKF-based smoother agree on this linear-equivalent system.
def test_cdnlgssm_smoother_linear_tregular(rng_keys):
    ...
    # Model definition: cd-dynamax linear model
    ...
    # Model definition: cd-dynamax nonlinear model with learnable functions set to be linear
    inputs = None  # No exogenous inputs used in this test
    ...
    for dynamics_approx_order in [1.0, 2.0]:
        ...
        for smoother_type in ["cd_smoother_1", "cd_smoother_2"]:
            ...
            print(
                f"Discrete to Continuous-Discrete {smoother_type} smoothed posterior tests passed!"
            )
