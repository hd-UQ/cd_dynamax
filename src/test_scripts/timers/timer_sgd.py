...
true_params, props = true_model.initialize(
    next(keys),
...
parser.add_argument('-T', '--total_time', default=10, type=float, help="Total simulation time")
...
parser.add_argument("-b", '--batch_size', default=1, type=int, help="SGD batch size")
