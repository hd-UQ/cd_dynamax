...
def main(**cfg):
    ...
    W_true[0, idx_of((1,0))] = 1.0        # + v
    W_true[0, idx_of((3,0))] = -1.0/3.0   # - v^3
    W_true[0, idx_of((0,1))] = -1.0       # - w
    W_true[0, idx_of((0,0))] = _I          # + I
    
    # Equation 2: w' = a*(v + b - c w) = a*v + a*b - a*c*w
    W_true[1, idx_of((1,0))] = _a          # + a*v
    W_true[1, idx_of((0,1))] = -_a*_c       # - a*c*w
    W_true[1, idx_of((0,0))] = _a*_b        # + a*b
...
if __name__ == "__main__":
    ...
    parser.add_argument("--T", type=int, default=400) # final time
