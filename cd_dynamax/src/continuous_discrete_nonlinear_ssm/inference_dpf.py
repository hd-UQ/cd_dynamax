...
# Our codebase
# CDNLSSM specific param and function definitions
...
# DPF filtering main function
def diff_particle_filter(
    key,
    params: ParamsCDNLSSM,
    ys: Array,
    us: Array | None = None,
    ...
    particles = params.initial.initial_distribution.sample(
    ...
    def _step(carry, inputs):
        ...
        # Only predict if idx > 0, otherwise keep initial particles (this allows for t_emissions[0] != 0)
        particles = lax.cond(idx > 0, _do_predict, lambda p: p, particles)
        # Update log weights with emission likelihoods
