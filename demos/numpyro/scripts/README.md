...
- Learning drift functions from noisy, irregularly-sampled data:
    ...
    - Lorenz 96 system:
        ...
        ```bash
        python l96_LaplaceDict.py --emission_dim 5 --state_dim 5
        ```
        - Sparse dictionary learning (10 components): 
        ```bash
        python l96_LaplaceDict.py --emission_dim 10 --state_dim 10 --N_particles 100
        ```
    ...
    - Linear SDE:
        ...
        ```bash
        python LinearGaussian_MultiTraj.py --emission_dim 5 --state_dim 5 --N_trajectories 30
        ```
        ...
        ```bash
        python LinearGaussian_MultiTraj_KF_Hierarchical.py --emission_dim 5 --state_dim 5 --N_trajectories 30
        ```
