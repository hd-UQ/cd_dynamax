...
def main(cfg):
    ...
    adjust_rhs_kwargs = {
        "lower_bound": cfg.state_bound_low,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--filter_type", type=str, default="EKF", choices=["EnKF", "EKF", "UKF"]
    )
    parser.add_argument(
        "--state_order",
        type=str,
    ...
    # Output settings
    parser.add_argument(
        "--dir", type=str, default="demo_outputs/LinearGaussian_MultiTraj"
    )
